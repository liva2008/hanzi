...
str1a = ['一','二','三','上','口','目','耳','手','日','田','禾','虫','云','山','八','十','了','子','人','大','月','儿','头','里','可','东','西','天','四','是','女','开','水','去','来','不','小','少','牛','果','鸟','早','书','刀','尺','本','木','林','土','力','心','中','五','立','正','在','后','我','好','长','比','巴','把','下','个','雨','们','问','有','半','从','你','才','明','同','学','自','已','衣','白','的','又','和','竹','牙','用','几','只','石','多','出','见','对','妈','全','回','工','厂']
str1b = []
for st in str1a:
    data = craw(st)
    print(data)
...
f = open('out1a.html', 'w', encoding='utf-8')
